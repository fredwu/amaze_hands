RSpec.describe Strategies::LeanKit::Reducers::LaneMovement do
  ...
  describe 'private tagging methods' do
    ...
    describe '#tag_created_in' do
      ...
      describe 'match' do
        let(:card_action) { FactoryGirl.build(:card_action, :analysable_created_in) }
